          ...
          <div className="lg:col-span-7">
            <div className="relative overflow-hidden rounded-3xl shadow-lg ring-1 ring-navy/10">
              ...
              <div className="absolute bottom-6 left-6 right-6">
                ...
                <p className="mt-1.5 font-display text-2xl leading-snug text-white">"The purpose of theology is doxology."</p>
              </div>
            </div>
            ...
            <div className="mt-5 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
              <div className="flex items-center justify-between">
                ...
                <span className="text-xs uppercase tracking-[0.18em] text-slate-500">Monthly</span>
              </div>
