...
export function Hero() {
  return (
    <section id="top" className="relative isolate min-h-screen overflow-hidden">
      {/* Background image — zoomed out, centered */}
      ...
      <div className="relative mx-auto flex min-h-screen max-w-7xl flex-col justify-end px-6 pb-20 pt-36 lg:px-10 lg:pb-28">
        <div className="max-w-3xl">
          ...
          <p className="max-w-xl text-pretty text-lg text-white/90 sm:text-xl">
          ...
          <div className="mt-10 flex flex-wrap items-center gap-4">
            ...
            <Link
              to="/papers"
              className="inline-flex items-center gap-3 rounded-full border border-white/50 px-7 py-4 text-sm font-semibold uppercase tracking-[0.16em] text-white transition hover:border-gold hover:text-gold"
            >
              Seminary Papers
            </Link>
            <Link
              to="/podcast"
              className="text-sm font-medium uppercase tracking-[0.16em] text-white/80 underline-offset-8 transition hover:text-gold hover:underline"
            >
              Podcast →
            </Link>
          </div>
        ...
        <div className="mt-16 hidden grid-cols-3 gap-12 border-t border-white/20 pt-7 text-white/80 md:grid">
          <div>
