...
const pastReadings = ["Mere Christianity — C. S. Lewis"];
        ...
        <div className="mx-auto grid max-w-7xl gap-16 px-6 lg:grid-cols-12 lg:gap-20 lg:px-10">
          <div className="lg:col-span-5">
            ...
            <h2 className="mt-5 font-display text-4xl font-light leading-[1.05] text-navy sm:text-5xl">
              Currently
              <span className="italic text-gold"> reading.</span>
            </h2>
            <div className="gold-rule my-8 max-w-[6rem]" />
            <p className="text-lg leading-relaxed text-slate-ink">
              Thursday nights at <span className="text-navy">7:00 PM EST</span>.
              Open to women across the country — join us in person or by Zoom.
            </p>
          </div>
          ...
          <div className="lg:col-span-7">
            <div className="glass-card rounded-3xl p-10">
              ...
              <h3 className="mt-4 font-display text-3xl font-light text-navy sm:text-4xl">
                Pilgrim's Progress
              </h3>
              <p className="mt-2 text-sm uppercase tracking-[0.22em] text-slate-ink">
                John Bunyan
              </p>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-10">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <h2 className="mt-5 font-display text-4xl font-light leading-tight text-navy sm:text-5xl">
              Other recommended
              <span className="italic text-gold"> book clubs.</span>
            </h2>
          </div>
            ...
            {otherClubs.map((c) => (
              <li key={c.name}>
                ...
                >
                  ...
                  <p className="mt-3 text-xs uppercase tracking-[0.22em] text-slate-ink">
                    {c.detail}
                  </p>
                  <span className="mt-6 inline-flex items-center gap-2 text-xs uppercase tracking-[0.2em] text-navy transition group-hover:text-gold">
