...
const essentials = [
  { title: "Institutes of the Christian Religion", author: "John Calvin", note: "The cornerstone of Reformed systematic theology." },
  { title: "The Bondage of the Will", author: "Martin Luther", note: "The hinge of the Reformation — grace, will, and Scripture." },
  { title: "Christianity and Liberalism", author: "J. Gresham Machen", note: "A bracing defense of historic Christian faith." },
  { title: "The Religious Affections", author: "Jonathan Edwards", note: "On the marks of true gracious affection in the soul." },
  { title: "Mere Christianity", author: "C. S. Lewis", note: "A masterwork of accessible Christian apologetics." },
  { title: "The Reason for God", author: "Timothy Keller", note: "Modern apologetics for the skeptical and seeking." },
];
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-10">
          ...
          <ul className="mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {essentials.map((b) => (
              <li
                key={b.title}
                className="group rounded-3xl border border-border bg-white p-8 shadow-soft transition hover:-translate-y-1 hover:border-gold hover:shadow-[var(--shadow-luxe)]"
              >
                <p className="eyebrow text-gold">{b.author}</p>
                <h3 className="mt-3 font-display text-2xl font-light leading-snug text-navy">
                  {b.title}
                </h3>
